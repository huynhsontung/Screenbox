...
public partial class MediaViewModel : ObservableRecipient
{
    ...
    [ObservableProperty]
    public partial bool IsMediaActive { get; set; }
    [ObservableProperty]
    public partial bool IsAvailable { get; set; } = true;
    [ObservableProperty]
    public partial AlbumViewModel? Album { get; set; }
    [ObservableProperty]
    public partial string Caption { get; set; } = string.Empty;  // For list item subtitle
    [ObservableProperty]
    public partial string AltCaption { get; set; } = string.Empty;  // For player page subtitle
