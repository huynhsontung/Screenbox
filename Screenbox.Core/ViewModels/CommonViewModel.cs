    ...
    IRecipient<PropertyChangedMessage<PlayerVisibilityState>>
{
    ...
    [ObservableProperty]
    public partial Thickness ScrollBarMargin { get; set; }
    [ObservableProperty]
    public partial Thickness FooterBottomPaddingMargin { get; set; }
    [ObservableProperty]
    public partial double FooterBottomPaddingHeight { get; set; }
