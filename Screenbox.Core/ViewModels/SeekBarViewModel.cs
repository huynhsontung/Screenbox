    ...
    IRecipient<PropertyChangedMessage<IMediaPlayer?>>
{
    ...
    [ObservableProperty]
    public partial bool IsSeekable { get; set; }

    [ObservableProperty]
    public partial bool BufferingVisible { get; set; }

    [ObservableProperty]
    public partial double PreviewTime { get; set; }

    [ObservableProperty]
    public partial bool ShouldShowPreview { get; set; }

    [ObservableProperty]
    public partial bool ShouldHandleKeyDown { get; set; }
