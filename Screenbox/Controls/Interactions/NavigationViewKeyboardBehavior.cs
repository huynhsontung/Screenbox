...
/// <summary>
/// A behavior that improves the keyboard interaction of the <see cref="Microsoft.UI.Xaml.Controls.NavigationView"/> built-in elements.
/// </summary>
internal class NavigationViewKeyboardBehavior : BehaviorBase<Microsoft.UI.Xaml.Controls.NavigationView>
{
    ...
    protected override void OnAssociatedObjectLoaded()
    {
        ...
        if (AssociatedObject.FindDescendant<Button>(pb => pb.Name == "TogglePaneButton") is { } togglePaneButton)
        {
            ...
            togglePaneButton.KeyboardAccelerators.Add(new KeyboardAccelerator() { Modifiers = CtrlKeyboardAcceleratorModifier, Key = TogglePaneKeyboardAcceleratorKey });
        }
