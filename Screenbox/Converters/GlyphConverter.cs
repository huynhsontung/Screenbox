...
public static partial class GlyphConverter
{
    ...
    public static string ToPlaybackCommandBadgeGlyph(PlaybackCommandKind kind, object? value)
    {
        ...
        return kind switch
        {
            ...
            PlaybackCommandKind.VolumeUp when value is int volume => ToVolumeGlyph(isMute: false, volume),
            PlaybackCommandKind.VolumeDown when value is int volume => ToVolumeGlyph(isMute: false, volume),
